<section class="bg-[#38BDF8] py-20 relative overflow-hidden">
  <div
    class="absolute inset-0 bg-gradient-to-r from-[#38BDF8] to-[#0EA5E9] animate-gradient"
  ></div>
  ...
  <div class="container mx-auto px-4 text-center relative z-10">
    ...
    <div class="opacity-0 transform translate-y-5 animate-fadeIn delay-400">
      <a
        href="../login"
        class="bg-[#0F172A] text-white hover:bg-[#1E293B] px-8 py-6 text-lg rounded-md inline-block transform transition-transform duration-200 ease-in-out hover:scale-105 active:scale-95"
      >
        Iniciar Sesión
      </a>
    </div>
